...
HxCFloppyEmulator_soft_beta\HxCFloppyEmulator_Software\Windows_x64\hxcfe -finput:%1 -foutput:%1.HxC.st -conv:ATARIST_ST

REM Convert to Atari .STX image (Protected)
HxCFloppyEmulator_soft_beta\HxCFloppyEmulator_Software\Windows_x64\hxcfe -finput:%1 -foutput:%1.HxC.stx -conv:ATARIST_STX


REM Convert to Amiga .ADF (Unprotected)
HxCFloppyEmulator_soft_beta\HxCFloppyEmulator_Software\Windows_x64\hxcfe -finput:%1 -foutput:%1.HxC.adf -conv:AMIGA_ADF

REM Convert to Amiga Extended .ADF (Protected)
REM HxCFloppyEmulator_soft_beta\HxCFloppyEmulator_Software\Windows_x64\hxcfe -finput:%1 -foutput:%1.HxC.extended.adf -conv:AMIGA_EXTADF 
