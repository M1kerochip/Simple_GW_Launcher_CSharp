...
REM Convert to .IPF
REM HxCFloppyEmulator_soft_beta\HxCFloppyEmulator_Software\Windows_x64\hxcfe -finput:%1 -foutput:%1.HxC.ipf -conv:SPS_IPF

REM Convert to .IPF (disk-analyse)
REM wsl.exe -d Ubuntu disk-analyse -v -fprobe_amiga %1 %1.libdisk.ipf > %1.libdisk.txt

REM Show Info
REM HxCFloppyEmulator_soft_beta\HxCFloppyEmulator_Software\Windows_x64\hxcfe -finput:%1 -foutput:%1.info_HxC.txt -infos
